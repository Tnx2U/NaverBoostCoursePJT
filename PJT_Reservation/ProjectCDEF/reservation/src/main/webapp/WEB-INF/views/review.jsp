						...
						<div class="short_review_area">
							<div class="grade_area">
								<span class="graph_mask"> <em class="graph_value"
									style="width: ${requestScope.graphValueWidth}%;"></em>
								</span> <strong class="text_value"> <span>${requestScope.averageScore}</span>
									<em class="total">5.0</em>
								</strong> <span class="join_count"><em class="green">${requestScope.commentList.size()}건</em>
									등록</span>
							</div>
							<ul class="list_short_review">
								<c:if test="${!requestScope.commentList.isEmpty()}">
									<c:forEach items="${requestScope.commentList}" var="comment">
										<li class="list_item">
											<div>
												<div class="review_area">
													<c:if test="${!comment.commentImages.isEmpty()}">
